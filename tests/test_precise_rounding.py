...
def run_cases(test_instance, cases, func):
    for parameters, expected in cases:
        with test_instance.subTest(parameters=parameters):
            result = func(*parameters)
            test_instance.assertEqual(expected, result)
...
class Test(TestCase):
    ...
    def test_03(self):
        ...
        cases = (
            ((123.456789, 0), ('123.456789', '0.000000')),
            ((123.000000, 0), ('123', '0')),
    ...
    def test_9(self):
        ...
        cases = (
            ((123.000000, 0.01, 4), ('123.00000', '0.01000')),
    ...
    def test_10(self):
        """big uncertainty"""
        cases = (
            ((123.0, 1001.234, 1), ('0', '1000')),
            ((123.0, 1001.234, 2), ('100', '1000')),
            ((123.0, 1001.234, 3), ('120', '1010')),
            ((123.0, 1001.234, 4), ('123', '1002')),
            ((123.0, 1001.234, 5), ('123.0', '1001.3')),
            ((123.0, 1001.234, 6), ('123.00', '1001.24')),
            ((123.0, 1001.234, 7), ('123.000', '1001.234')),
        )
        run_cases(self, cases, precise_rounding)
    ...
    def test_11(self):
        """small uncertainty"""
        cases = (
            ((1.23E+15, 1E-15, 1), ('1.23E+15', '1E-15')),
            ((1.23E+15, 1E-15, 2), ('1.23E+15', '1.0E-15')),
            ((1.23E+15, 1E-15, 3), ('1.23E+15', '1.00E-15')),
            ((1.23E+25, 1E-25, 1), ('1.23E+25', '1E-25')),
            ((1.23E+25, 1E-25, 2), ('1.23E+25', '1.0E-25')),
            ((1.23E+25, 1E-25, 3), ('1.23E+25', '1.00E-25')),
        )
        run_cases(self, cases, precise_rounding)
    ...
    def test_12(self):
        """big values"""
        cases = ( # TODO: fix it
            ((1.23E+15, 1E+13, 1), ('1.23E+15', '1E+13')),
            ((1.23E+15, 1E+13, 2), ('1.23E+15', '1.0E+13')),
            ((1.23E+15, 1E+13, 3), ('1.23E+15', '1.00E+13')),
            ((1.23E+25, 1E+23, 1), ('1.23E+25', '1E+23')),
            ((1.23E+25, 1E+23, 2), ('1.23E+25', '1.0E+23')),
            ((1.23E+25, 1E-23, 3), ('1.23E+25', '1.00E+23')),
        )
        run_cases(self, cases, precise_rounding)
    ...
    def test_exceptions(self):
        ...
        cases = (
            (('abc', 0.01), TypeError),
            ((10.0, 'abc'), TypeError),
            ((1.0, 0.01, 'abc'), TypeError),
            ((1.0, -0.01), ValueError),
            ((1.0, 0.01, 0), ValueError),
            ((1.0, 0.01, -1), ValueError),
        )
